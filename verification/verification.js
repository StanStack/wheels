...
class Verification {
    ...
    hideBox() {
        ...
        document.querySelector('.a-hide').addEventListener('animationend', self.animateHide)//动画结束时添加事件
    }
    // 消失动画
    animateHide () {
    ...
    move(event) {
        ...
        var nowX = event.clientX ? event.clientX : event.touches[0].clientX //鼠标或者触摸的偏移
